# 강릉 당일치기 여행 코스 (12:10 도착 → 22:00 출발)
...
graph TD
    ...
    D --> E[16:15-17:30 경포해변<br/>🏖️ 해변 산책 & 휴식]
    E --> F[17:45-19:00 저녁식사<br/>🦑 머구리횟집 물회]
    F --> G[19:15-20:30 안목해변<br/>☕ 카페거리 & 일몰]
    G --> H[20:45-21:30 테라로사<br/>☕ 강릉 커피 본점]
    H --> I[21:45-22:00 출발 준비<br/>🚗 복귀]
...
graph LR
    ...
    subgraph "자연 관광 (15:15-17:30)"
        N1[경포대<br/>🌊 관동팔경] --> N2[경포해변<br/>🏖️ 6km 백사장]
    end
    
    subgraph "저녁 코스 (17:45-19:00)"
        D1[머구리횟집<br/>🦑 현지인 추천 물회]
    end
    
    subgraph "카페 투어 (19:15-21:30)"
...
gantt
    ...
    복귀 출발           :milestone, departure, 22:00, 0m
...
graph TD
    subgraph "점심 추천 (12:30-13:30)"
        A1[1순위: 삼교리동치미막국수<br/>⭐4.6 | 🏅현지인맛집<br/>📍 삼교리]
        A2[2순위: 금학칼국수<br/>⭐4.4 | 🏅숨은맛집<br/>📍 금학동]
        A3[3순위: 형제칼국수<br/>⭐4.5 | 🏅로컬단골<br/>📍 시내]
    end
    
    subgraph "저녁 추천 (17:45-19:00)"
        B1[1순위: 머구리횟집<br/>⭐4.5 | 🏅물회전문<br/>📍 사천면]
        B2[2순위: 동해바다샵1971<br/>⭐4.6 | 🏅가성비해산물<br/>📍 포남동]
        B3[3순위: 아스따<br/>⭐4.8 | 🏅현지인90%<br/>📍 강릉역근처]
    end
    
    subgraph "카페 추천 (19:15-21:30)"
        C1[필수: 안목해변 카페거리<br/>⭐4.7 | 🏅바다뷰카페<br/>📍 안목항]
        C2[필수: 테라로사 본점<br/>⭐4.7 | 🏅강릉커피성지<br/>📍 구정면]
    end
